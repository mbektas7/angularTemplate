...
export class MirapiInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {MirapiMatchMediaService} _mirapiMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _mirapiMediaMatchService: MirapiMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._mirapiMediaMatchService.onMediaChange
