...
import '@mirapi/components/highlight/prism-languages';

@Component({
    selector : 'mirapi-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class MirapiHighlightComponent implements OnInit, OnDestroy
{
    // Source
    //@ContentChild('source')
    source: ElementRef; 
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using mirapi-highlight
        // component
