...
@Component({
    selector   : 'mirapi-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : mirapiAnimations
})
export class MirapiNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._mirapiNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._mirapiNavigationService.onItemCollapsed.next(this.item);
        this._mirapiNavigationService.onItemCollapseToggled.next();
    }
