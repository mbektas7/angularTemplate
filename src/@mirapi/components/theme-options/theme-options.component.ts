...
@Component({
    selector     : 'mirapi-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : mirapiAnimations
})
export class MirapiThemeOptionsComponent implements OnInit, OnDestroy
{
    mirapiConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._mirapiConfigService.config = config;
            });
        ...
        this._mirapiNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._mirapiNavigationService.removeNavigationItem('custom-function');
    }
