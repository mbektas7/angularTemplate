...
import { MirapiSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'mirapi-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class MirapiSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._mirapiConfigService.config
            ...
            .subscribe((config) => {
                this._mirapiConfig = config;
            });

        // Register the sidebar
        this._mirapiSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._mirapiSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('mirapi-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('mirapi-sidebar-overlay-invisible');
        }
